    ...
    return (
        <main className="relative flex min-h-screen items-center justify-center bg-[url('./assets/bg-gallery.png')] bg-cover bg-center bg-no-repeat px-4 py-12 sm:px-6 lg:px-8">
            ...
            <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
                <div className="h-[30rem] w-[30rem] rounded-full bg-zinc-900/40 blur-[120px]" />
            </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="space-y-4">
                            <div className="space-y-1.5">
                                <label htmlFor="user_id" className="block text-sm font-medium text-zinc-300">
                                    Identifiant
                                </label>
                                <input
                                    type="text"
