...
export default function RegisterComponent() {
    ...
    return (
        <>
            <main className="relative isolate flex min-h-screen items-center justify-center overflow-hidden bg-[url('./assets/bg-gallery.png')] bg-cover bg-center bg-no-repeat px-4 py-12 sm:px-6 lg:px-8">
                ...
                <section className="relative z-10 w-full max-w-md overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-950 shadow-2xl">
                    ...
                    <div className="px-6 py-8 sm:px-8 sm:py-10">
                        ...
                        <p className="mt-8 text-center text-sm text-zinc-500">
                            ...
                            <Link to="/login" className="font-medium text-white transition-colors hover:text-zinc-300">
                                Connectez-vous
                            </Link>
                        </p>
                    </div>
